...
class Plotter:
    ...
    def plot_oneD(self, fig_num, x, y, xlab_str1D=r'$x$', ylab_str1D=r'', titlelab_str=r'', legendlab_str=r'', linestyle_str='ko:', LW_set=None, MSZ_set=None, semilogy=False, loglog=False, markerfc=False, fig_width=None, fig_height=None, fig_sz_default=False):
        """
        fig_num: Figure Number for this plot
        ...
        if fig_sz_default:
            ...
            fig = plt.figure(fig_num, figsize=(FIG_MAX_WIDTH, FIG_MAX_WIDTH)) # figsize=(5.1667, 8.5166)
        if semilogy:
